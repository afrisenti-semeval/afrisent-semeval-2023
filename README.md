...
The dataset is also available on [HugginFace](https://huggingface.co/datasets/shmuhammad/AfriSenti-twitter-sentiment) or [data](https://github.com/afrisenti-semeval/afrisent-semeval-2023/tree/main/data)
